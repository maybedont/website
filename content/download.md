...
The latest version is `v0.2.1` - you can download a binary for your architecture below:

{{< list-files-for-version version = v0.2.1 >}}
...
audit:
  enabled: true
  path: /Users/user/maybe-dont_0.2.1_Darwin_arm64/audit.log
```
...
# claude_desktop_config.json
{
  "mcpServers": {
    "maybe-dont": {
      "command": "/Users/user/Downloads/maybe-dont_0.2.1_Darwin_arm64/maybe-dont",
      "args": [
        "start",
        "--config-path=/Users/user/Downloads/maybe-dont_0.2.1_Darwin_arm64"
      ],
      "env": {
...
The latest container image is available at `ghcr.io/maybedont/maybe-dont:v0.2.1`. You can run it with something like:
...
podman run \
  ...
  -p 8080:8080 \
  ghcr.io/maybedont/maybe-dont:v0.2.1 start
```
